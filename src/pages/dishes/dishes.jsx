    ...
    <div className="container mx-auto max-w-4xl lg:max-w-6xl my-6 px-4 md:px-6">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center border px-3 ">
          ...
          <input id="breakfast" type="checkbox" className="w-4 h-4 px-3 " />
        </div>
        <div className="flex items-center px-3 border ">
          ...
          <input id="dinner" type="checkbox" className="w-4 h-4 px-3" />
        </div>
        <div className="flex items-center px-3 border">
          <label
            htmlFor="lunch"
          ...
          <input id="lunch" type="checkbox" className="w-4 h-4 px-3" />
        </div>
      </div>
      <hr className="mt-4" />
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-2 lg:gap-3">
        {dishes.map((dishItem, index) => {
          return (
            dishItem.isActive && (
              <div key={"dish-card" + index} className="hover:shadow-lg">
